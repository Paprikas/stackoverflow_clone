...
describe 'Questions API' do
  ...
  context 'authorized' do
    ...
    describe 'GET /:question_id/answers' do
      let!(:answers) { create_pair(:answer, question: question2) }
      let(:answer) { answers.last }

      before do
        get "/api/v1/questions/#{question2.id}/answers", params: {access_token: access_token.token, format: :json}
      end
  ...
  context 'not authorized' do
    ...
    describe 'GET /:question_id/answers' do
      it_behaves_like 'unauthorized access', "/api/v1/questions/1/answers"
    end
    ...
    describe 'POST /:question_id/answers' do
      it_behaves_like 'unauthorized post access', "/api/v1/questions/1/answers"
    end
  end
end
